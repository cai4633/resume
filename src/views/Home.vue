<template>
  <div class="home">
    ...
    <header>
      ...
      <div :class="{'header-inner':true, 'clearfix':true,'scroll':isScroll}" id="headerInner">
        <a href="#" class="logo">
          <span>RS</span>card
        </a>
        <nav>
          <ul class="clearfix">
            <li>
              <a href="#profile" class="active slideSlowly">关于</a>
            </li>
            <li>
              <a href="#skill" class="slideSlowly">技能</a>
            </li>
            <li>
              <a href="#portfolio" class="slideSlowly">作品</a>
            </li>
            <li>
              <a href="https://caijd.top" target="_blank">博客</a>
            </li>
            <li>
              <a href="javascript:;">日历</a>
            </li>
            <li>
              <a href="#profile" class="slideSlowly">联系方式</a>
            </li>
            <li>
    ...
    <main>
      <div class="profile bounce" id="profile" data-x>
        ...
        <footer>
          <a href="https://github.com/cai4633">
          ...
          <a>
            <svg class="icon" aria-hidden="true">
              <use xlink:href="#icon-changyonglogo28" />
            </svg>
          </a>
          <a>
            <svg class="icon" aria-hidden="true">
      ...
      <a href="javascript:;" download class="download">
        <button>DOWNLOAD RESUME</button>
      </a>
      <p class="selfIntroduction">
        Hello! I’m Robert Smith. Senior Web Developer specializing in front end
        development. Experienced with
        <br />all stages of the development cycle for
      ...
      <ul class="clearfix">
        <li>
          ...
          <div class="processItem">
            <div class="processBar" style="width:80%;"></div>
          </div>
        </li>
        <li>
          <h3>HTML</h3>
          <div class="processItem">
            <div class="processBar" style="width:60%;"></div>
          </div>
        </li>
        <li>
          <h3>CSS</h3>
          <div class="processItem">
            <div class="processBar" style="width:40%;"></div>
          </div>
        </li>
        <li>
          <h3>VUE</h3>
          <div class="processItem">
            <div class="processBar" style="width:20%;"></div>
          </div>
        </li>
        <li>
          <h3>Javsscript</h3>
          <div class="processItem">
            <div class="processBar" style="width:90%;"></div>
          </div>
        </li>
        <li>
          <h3>Nodejs</h3>
          <div class="processItem">
            <div class="processBar" style="width:30%;"></div>
          </div>
        </li>
      </ul>
    </section>
    ...
    <section class="portfolio bounce" id="portfolio" data-x>
      ...
      <nav>
        <ul>
          <li @click="classList=['state1']">ALL</li>
          <li @click="classList=['state2']">PHOTOGRAPHY</li>
          <li @click="classList=['state3']">NATURE</li>
        </ul>
        <div class="bar">
          <div class="bar-inner" :class="classList"></div>
        </div>
      </nav>
...
export default {
  ...
  methods: {
    // 初始化
    init(){
        let timeout1 = setTimeout(() => { $('#loading').removeClass("loading-active")}, 1500); //  加入loading动画
        this.slideSlowlyBindEvent();
        window.onscroll = this.windowBindEvent
        this.navActive()
    },
    ...
    // sticky navbar
     addStickyBar() { this.isScroll = (window.scrollY > 0) ?  1 : 0 },

    //click导航条滑动到指定element
     slideSlowlyBindEvent() {
       $(".slideSlowly").on("click", (e) => {
          e.preventDefault();
...
background-color rgb(239, 239, 239), .loading {
  display: none;
}
...
header {
  .banner {
    ...
    background-image: url('../assets/images/rs-cover.jpg');

    &::before {
      content: ''; // 伪元素必须设置content否则无效
      display: block; // 默认是inline元素，inline元素不确定因素太多
      height: 100%;
      ...
      &>ul>li { // 尽量用子元素选择器防止后代选择出现干扰项
        ...
        &>a {
          ...
          &::after {
            ...
            display: block;
            height: 3px;
            background-color: rgb(7, 203, 121);
            margin-top: 10px;
            width: 0%;
            border-radius: 5px;
            transition: all 0.5s;
...
main {
  .profile {
    ...
    margin-top: -340px;
    text-align: left;
    box-shadow: -1px 2px 3px 0px rgba(0, 0, 0, 0.46);
      ...
      .card {
        ...
        .welcome {
          ...
          &::after {
            ...
            width: 0px;
            height: 0px;
            border: 4px solid rgb(7, 203, 121);
    ...
    &>footer {
      text-align: center;
      background-color: rgb(7, 203, 121, 0.7);
      ...
      &>a {
        ...
        &:hover {
          background-color: rgb(6, 182, 109);
        }
...
section.portfolio {
  ...
  &>.content {
    ...
    .work {
      ...
      img {
        display: block; // TODO:深入理解baseline,vertical-align的关系，其中只有包含文本内容（不包括图片）的inline或者inline-block元素才是本身的baseline，否则baseline就是margin-bottom。
        transition: all 0.5s linear;
        transform: scale(1, 1);
      }
      ...
      &:hover {
        img {
          transform: scale(1.1, 1.1); // 使用img缩放比用background-size缩放要流畅
        }
